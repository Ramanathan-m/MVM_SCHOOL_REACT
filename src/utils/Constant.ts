...
export const ProjectManagement= "Project Management"
...
export const MSchools = "Schools";
export const MDepartments = "Departments";
export const MVendors = "Vendors";
export const MLinks = "Links";
export const MTags = "Tags";
export const MAddSchools = "Add Schools";
...
export const SchoolAddress = "Address";
...
export const AOldRequests = "Old Requests";
export const APendingRequests = "Pending Requets";
export const ACancelledRequets = "Cancelled Requests";
export const ViewForm = "View Requests";
export const Approve = "Approve ";
export const Hold = "Hold ";
export const ViewCardCancel = "Cancel";
...
export const PUserName = "girish15";
export const PChangePassword = "Change password";

// VendorForm
export const VendorFormName= "Vendor Name"
export const VendorFormType= "Contact Person"
export const VendorFormLink= "Address"
export const VendorFormSchoolDescription= "State"
export const VendorFormCity= "City"
export const VendorsFormPincode= "Pincode"
export const VendorFormEmailId= "Email id"
export const VendorPhoneNumber= "Phone Number"
export const VendorGstnumber= "GST Number"
export const VendorPanNumber= "PAN Number"
export const VendorFormServices= "Services"

// LinkForm
export const LinksFromType= "Type"
export const LinksFromLink= "Link"
export const LinksFromDescription= "Description"
export const selectschool="select school"
export const From="From"
export const To="To"
export const SearchStatus="Status"
export const SearchSchool="School"
...
export const RaiseRequestImage="Image"
export const RaiserequestsApproximateBudget="ApproximateBudget"
export const RaiserequestsPriority="Priority"
export const RaiserequestsBasic="Basic (< 10000)"
export const Raiserequestintermediate="Intermediate (>=10000)"
export const RaiserequestAdvance="(Construction)"
export const RaiserequestsLow="Low"
export const RaiserequestsMedium="Medium "
export const RaiserequestsHigh="High"

// user
export const UsersName="Name"
export const UsersEmailId="Email Id"
export const UsersPhoneNumber="Phone Number"
export const Usersname="Username"
export const UsersPassword="Password"
export const UsersConfirmPassword="Confirm Password"
...
export const BasicSubmitButton = "Add";
