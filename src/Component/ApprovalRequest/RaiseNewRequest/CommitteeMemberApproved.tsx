            ...
            <Col sm="12" lg="12" xl="12">
                <table className="table table-hover ">
                    ...
                    <tbody>
                        ...
                        <td> <Link to={`${process.env.PUBLIC_URL}/approvalrequest/committeememberapprovedviewcard`}><i className="fa fa-eye"></i></Link>
                            <span>  </span>
...
export default CommitteMemberApproved