...
const InprogressRequestViewCard = () => {
  return (
    <Col md="12" xl="12">
        ...
        <Row className="g-3">
          ...
          <Col md="12" xl="6">
            <div className="form-group row mt-2">
              ...
              <div className="col-xl-5 col-lg-6 col-md-6 col-sm-6 col-xs-12">{"20-07-2024 10:30 PM"}</div>
            </div>
          </Col>
        </Row>
        <Row className="g-3">
          <Col md="12" xl="6">
            <div className="form-group row mt-2">
              ...
              <div className="col-xl-5 col-lg-6 col-md-6 col-sm-6 col-xs-12">{"Account Admin"}</div>
            </div>
          </Col>
          <Col md="12" xl="6">
            <div className="form-group row mt-2">
        ...
        <Row className=" form-group row mt-2">
          ...
          <Col md="12" xl="6">
            <div className="form-group row mt-2 ">
              ...
              <div className="col-xl-5 col-lg-6 col-md-6 col-sm-6 col-xs-12 d-flex gap-1">
                <Badge color="success">{"PO Uploaded"}</Badge>
              </div>
            </div>
          </Col>
        </Row>
...
export default InprogressRequestViewCard